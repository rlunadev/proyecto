...
function getAll(){
	$.ajax({
		type: 'POST',
		url:{!!json_encode(url('/'))!!}+"/api/tipoPago/GetAll?token="+localStorage.getItem('token'),
...
function deleteById (id){
	$.ajax({
		type: 'POST',
		url:{!!json_encode(url('/'))!!}+"/api/tipoPago/DeleteById?token="+localStorage.getItem('token'),
    data:{
      id:id
    },
		success: function(result) {
...
function SaveData (nombre,descripcion){
	$.ajax({
		type: 'POST',
		url:{!!json_encode(url('/'))!!}+"/api/tipoPago/SaveData?token="+localStorage.getItem('token'),
    data:{
      nombre:nombre,
...
function GetById (id){
	$.ajax({
		type: 'POST',
		url:{!!json_encode(url('/'))!!}+"/api/tipoPago/GetById?token="+localStorage.getItem('token'),
    data:{
      id:id
    },
		success: function(result) {
...
function update (nombre,descripcion){
	$.ajax({
		type: 'POST',
		url:{!!json_encode(url('/'))!!}+"/api/tipoPago/Update?token="+localStorage.getItem('token'),
    data:{
      id:auxId,
      nombre:nombre,
      descripcion:descripcion
